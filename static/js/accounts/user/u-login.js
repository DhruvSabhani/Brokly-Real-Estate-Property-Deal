...
document.getElementById('uSelectedState').innerText = window.stateEr.selectState;
...
document.getElementById('uSelectedCity').innerText = window.cityEr.selectCity;
  ...
  fetch('/verify-otp/', {
    ...
    .then((data) => {
      ...
      if (data.profile) {
        ...
        uSelectedState.innerText = data.profile.state_name || window.stateEr.selectState;
        ...
        uSelectedCity.innerText = data.profile.city_name || window.cityEr.selectCity;
